...
local colors = {
  ...
  border = "#2a4a3d",
  border_variant = "#0f1f1a",

  -- Syntax colors
  keyword = "#e85d04",
  string = "#4a8c5c",
  string_escape = "#659d74",
  number = "#d4a017",
  boolean = "#d4a017",
  constant = "#5a9a8c",
  func = "#8a5a8a",
  ...
  -- Selection and search (Fixed: Removed alpha channels)
  selection = "#e85d04",
  search = "#d4a017",
  visual = "#e85d04",
  cursor = "#e85d04",
...
-- Git Signs (Fixed: Removed alpha channels)
...
hl("GitSignsAddLn", { bg = "#4a8c5c" })
hl("GitSignsChangeLn", { bg = "#d4a017" })
hl("GitSignsDeleteLn", { bg = "#c92a2a" })

-- Diff (Fixed: Removed alpha channels)
hl("DiffAdd", { fg = colors.none, bg = "#4a8c5c" })
hl("DiffChange", { fg = colors.none, bg = "#d4a017" })
hl("DiffDelete", { fg = colors.git_delete, bg = "#c92a2a" })
hl("DiffText", { fg = colors.none, bg = "#d4a017" })
